...
public class CacheInvocationHandler implements InvocationHandler {
    ...
    // Пробовала несколько вариантов, показалось странным, что можно обойтись было без мутатора
    // Однако в условии задачи акцент делается на аннотацию Mutator
    // Долго не получалось, но это мой вариант решения (сначала сделала и проверила, потом после добавления нового поля и его изменения тест отрабатывает неправильно)
